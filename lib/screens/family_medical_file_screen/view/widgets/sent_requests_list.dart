  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Container(
        ...
        child: InkWell(
          onTap: () {
            familyMedicalFileScreenController.onSentRequestsListClick();
          },
          child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: familyMedicalFileScreenController
                            .isMessagesRequestsCollaps.value
                        ? ConstAssets.arrowUpward
                        : ConstAssets.arrowDownward,
                  ),
                ],
              ),
              familyMedicalFileScreenController.isMessagesRequestsCollaps.value
                  ? Expanded(
